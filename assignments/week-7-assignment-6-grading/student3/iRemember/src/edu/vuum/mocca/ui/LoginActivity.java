...
public class LoginActivity extends StoryActivityBase{
	...
	public void loginClicked(View v){
		...
		try {
			//FIX: open the file in private mode before writing the login information in it
			FileOutputStream outputStream = openFileOutput(loginFile.getAbsolutePath(), Context.MODE_PRIVATE);
			
			BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(outputStream));	// Line 113
